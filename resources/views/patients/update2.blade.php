                        ...
                        <div class="form-row">
                            <div class="col-md-6 form-group mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" name="dob" id="datePicker" class="form-control"
                                           placeholder="Enter birth date" required value="{{ old('dob') }}">
                            ...
                            <div class="form-group mb-4 col-md-2">
                                ...
                                <input name="weight" type="text" class="form-control" id="input_weight"
                                       placeholder="Enter weight (KG)" required value="{{ old('weight') }}">
                                <small class="ul-form__text form-text ">
                                    Please select your birth date
                                </small>
                            ...
                            <div class="form-group mb-4 col-md-2">
                                ...
                                <input name="height" type="text" class="form-control" id="input_height"
                                       placeholder="Enter height (CM)" required value="{{ old('height') }}">
                                <small class="ul-form__text form-text ">
                        ...
                        <div class="form-row ">
                            <div class="form-group mb-4 col-md-6">
                                ...
                                <input name="phone" type="number" class="form-control" id="input_contact"
                                       placeholder="Enter contact number" required value="{{ old('phone') }}">
                                <small class="ul-form__text form-text ">
                        ...
                        <div class="form-row">
                            <div class="form-group mb-4 col-md-6">
                                ...
                                <input name="address_1" type="text" class="form-control" id="input_address_1"
                                       placeholder="Enter address" required value="{{ old('address_1') }}">
                                <small class="ul-form__text form-text ">
                            ...
                            <div class="form-group mb-4 col-md-6">
                                ...
                                <input name="address_2" type="text" class="form-control" id="input_address_2"
                                       placeholder="Enter address" required value="{{ old('address_2') }}">
                                <small class="ul-form__text form-text ">
                                    Please enter your address
                                </small>
                                <div class="invalid-tooltip">Please enter your address</div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group mb-4 col-md-3">
                                ...
                                <input name="postcode" type="number" class="form-control" id="input_postcode"
                                       placeholder="Enter postcode" required value="{{ old('postcode') }}">
                                <small class="ul-form__text form-text ">
