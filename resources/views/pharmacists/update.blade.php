        ...
        <div class="col-lg-9 col-md-12 mb-3">
            <div class="card">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">Pharmacist's Information</h3>
                </div>
                <!--begin::form-->
                <form action="{{ route('pharmacists.update', $pharmacist)}}" method="post" class="needs-validation" novalidate>
                    @csrf
                    @method('PUT')
                    <div class="card-body">
...
{{--    <script src="{{ asset('js/pharmacist.js') }}"></script>--}}
